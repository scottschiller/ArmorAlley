  ...
  return src(`${dp.image}/${spriteSheet.json}`)
    ...
    .pipe(
      map((file, done) => {
        ...
        const output = [
          `// Note: this file was generated by the build process. See src/README.md for details.\n`,
...
const copyStaticResourcesTasks = [
  ...
  function images() {
    /**
     * Copy all image subdirectories, ignoring .png files inside image/
     * itself which are bundled into a spritesheet.
     *
     * UI/ images are largely (but not entirely) redundant as anything
     * < 2 KB is base64-encoded in CSS.
     */
    return binarySrc([
      `${assetPath}/${imagePath}/**/*`,
