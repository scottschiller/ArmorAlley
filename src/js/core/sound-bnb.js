...
function addBNBSounds() {
  ...
  bnb.buttheadMonologues = shuffle([
    ...
    addSequence(
      addVL(
        'bh_mockery_this_sucks_b_can_you_handle_this_bh_i_gotta_take_a_leak'
      ),
  ...
  bnb.beavisRetorts = shuffle([
    ...
    addSequence(
      ...
      addVL(
        'bh_you_mean_youre_gonna_go_polish_your_helmet_you_are_correct_sir'
      ),
  ...
  bnb.gameOverWin = addSequence(
    ...
    oneOf(
      bnb.boioioing.filter(
        (boing) => boing.options.url.indexOf('boing_b') === -1
      )
    ),
    add('bh_that_was_stupid_beavis_but_it_was_pretty_cool_too'),
    add('beavis_i_scored', 75)
  ...
  bnb.beavisThanks = shuffle([
    ...
    add('b_you_know_i_have_feelings'),
  ...
  bnb.gameMenu = shuffle([
    ...
    addGMS(
      add('bh_this_is_the_coolest_game_ive_ever_played'),
      addVL('b_fryer')
    ),
    addGMS(
